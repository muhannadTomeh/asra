...
namespace Asrati.ViewModels.SeasonViewModel
{
    public class SeasonCreateViewModel
    {
        ...
        [Required]
        [Range(0, double.MaxValue, ErrorMessage = "Price per kg of oil must be a positive value.")]
        public decimal PricePerKgOil { get; set; }
        ...
        [Required]
        [Range(0, double.MaxValue, ErrorMessage = "Worker salary per hour must be a positive value.")]
        public decimal WorkerSalaryPerHour { get; set; }
